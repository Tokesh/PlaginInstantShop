...
for i in products:
  ...
  if(a_store <= metro and a_store <= carefood):
    file_writer.write(f"{i};A-Store;{all_categories[i]};{a_store}\n")
    print(f"{i};A-Store;{all_categories[i]};{a_store}")
  elif(metro < a_store and metro <carefood):
    file_writer.write(f"{i};Metro;{all_categories[i]};{metro}\n")
    print(f"{i};Metro;{all_categories[i]};{metro}")
  else:
    file_writer.write(f"{i};Carefood;{all_categories[i]};{carefood}\n")
    print(f"{i};Carefood;{all_categories[i]};{carefood}")
